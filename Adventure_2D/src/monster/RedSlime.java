...
public class RedSlime extends Entity {
	...
	public RedSlime(GamePanel gp) {
		...
		this.def = 0;
		this.exp = 5;
		this.projecttile = new OBJRock(this.gp);
		this.solidArea.x = 3;
		this.solidArea.y = 18;
	...
	public void getImage() {
		this.up1 = this.Setup("/monster/slime/hell/redslime_1", this.gp.tileSize, this.gp.tileSize);
		this.up2 = this.Setup("/monster/slime/hell/redslime_2", this.gp.tileSize, this.gp.tileSize);
		this.down1 = this.Setup("/monster/slime/hell/redslime_1", this.gp.tileSize, this.gp.tileSize);
		this.down2 = this.Setup("/monster/slime/hell/redslime_2", this.gp.tileSize, this.gp.tileSize);
		this.left1 = this.Setup("/monster/slime/hell/redslime_1", this.gp.tileSize, this.gp.tileSize);
		this.left2 = this.Setup("/monster/slime/hell/redslime_2", this.gp.tileSize, this.gp.tileSize);
		this.right1 = this.Setup("/monster/slime/hell/redslime_1", this.gp.tileSize, this.gp.tileSize);
		this.right2 = this.Setup("/monster/slime/hell/redslime_2", this.gp.tileSize, this.gp.tileSize);
	}
		...
		if (this.gp.currentPlayer != null) {
			if (this.gp.currentPlayer == this.gp.boy && this.gp.boy.type == this.gp.currentPlayer.type_player_boy) {
				...
				if (this.onPath == true) {
					...
					this.searchPath(getGoalCol(this.gp.boy), getGoalRow(this.gp.boy));
			...
			if (this.gp.currentPlayer == this.gp.girl && this.gp.girl.type == this.gp.currentPlayer.type_player_girl) {
				...
				if (this.onPath == true) {
					...
					this.searchPath(getGoalCol(this.gp.girl), this.getGoalRow(this.gp.girl));
