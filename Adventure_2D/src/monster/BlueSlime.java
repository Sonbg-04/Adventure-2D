...
public class BlueSlime extends Entity {
	...
	public void getImage() {
		this.up1 = this.Setup("/monster/slime/frozen/blueslime_1", this.gp.tileSize, this.gp.tileSize);
		this.up2 = this.Setup("/monster/slime/frozen/blueslime_2", this.gp.tileSize, this.gp.tileSize);
		this.down1 = this.Setup("/monster/slime/frozen/blueslime_1", this.gp.tileSize, this.gp.tileSize);
		this.down2 = this.Setup("/monster/slime/frozen/blueslime_2", this.gp.tileSize, this.gp.tileSize);
		this.left1 = this.Setup("/monster/slime/frozen/blueslime_1", this.gp.tileSize, this.gp.tileSize);
		this.left2 = this.Setup("/monster/slime/frozen/blueslime_2", this.gp.tileSize, this.gp.tileSize);
		this.right1 = this.Setup("/monster/slime/frozen/blueslime_1", this.gp.tileSize, this.gp.tileSize);
		this.right2 = this.Setup("/monster/slime/frozen/blueslime_2", this.gp.tileSize, this.gp.tileSize);
	}
